...
type FeatureClient interface {
	...
	AddFeature(ctx context.Context, in *FeatureStruct, opts ...grpc.CallOption) (*IdStruct, error)
...
func (c *featureClient) AddFeature(ctx context.Context, in *FeatureStruct, opts ...grpc.CallOption) (*IdStruct, error) {
	out := new(IdStruct)
...
type FeatureServer interface {
	...
	AddFeature(context.Context, *FeatureStruct) (*IdStruct, error)
...
func (UnimplementedFeatureServer) AddFeature(context.Context, *FeatureStruct) (*IdStruct, error) {
