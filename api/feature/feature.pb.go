...
var file_feature_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x32, 0xf3, 0x03, 0x0a, 0x07, 0x46, 0x65, 0x61,
	...
	0x64, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x42, 0x0d,
	0x5a, 0x0b, 0x61, 0x70, 0x69, 0x2f, 0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x62, 0x06, 0x70,
...
var file_feature_proto_depIdxs = []int32{
	...
	2, // 8: FeatureService.Feature.AddPriority:output_type -> FeatureService.PriorityStruct
	1, // 9: FeatureService.Feature.AddFeature:output_type -> FeatureService.FeatureStruct
	0, // 10: FeatureService.Feature.DelPriority:output_type -> FeatureService.Empty
	0, // 11: FeatureService.Feature.DelFeature:output_type -> FeatureService.Empty
	0, // 12: FeatureService.Feature.EditPriority:output_type -> FeatureService.Empty
	0, // 13: FeatureService.Feature.EditFeature:output_type -> FeatureService.Empty
	4, // 14: FeatureService.Feature.Get:output_type -> FeatureService.HibrydFeatureList
